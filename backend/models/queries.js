module.exports = {
  getProfile: 'SELECT name, course_name AS course, student_id AS id, profile_id, dob, attendance_pct AS attendance, photo_url FROM students WHERE student_id = ?',
  ...
  registerStudent: 'INSERT INTO students (student_id, name, course_name, dob, attendance_pct, photo_url, validity, gender, profile_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
